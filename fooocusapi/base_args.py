...
def add_base_args(parser: ArgumentParser, before_prepared: bool):
    ...
    parser.add_argument("--apikey", type=str, default="AIzaSyD7Q7J9Q", help="API key for authenticating requests")
    ...
    parser.add_argument("--enable-insecure-extension-access", default=False, action="store_true", help="ads")
